...
export class AppError implements ApiError {
  ...
  constructor(message: string, statusCode: number, isOperational = true, errors?: any, code?: number) {
   ...
   */
  static forbidden(message: string = 'Acesso proibido'): AppError {
   ...
   */
  static conflict(message: string = 'Conflito de dados'): AppError {
